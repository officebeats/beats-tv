...
@Component({
  selector: 'app-animated-shader-background',
  template: `
    <div #container class="shader-background-container">
      <!-- Shader canvas will be appended here -->
    </div>
  `,
  styles: [
    `
...
export class AnimatedShaderBackgroundComponent implements AfterViewInit, OnDestroy {
